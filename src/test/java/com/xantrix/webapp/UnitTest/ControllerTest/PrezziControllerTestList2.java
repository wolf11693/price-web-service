...
public class PrezziControllerTestList2 {
	...
	@Test
	public void A_getListino2CodArtTest() throws Exception {
		MockHttpServletRequestBuilder httpMockRequest = MockMvcRequestBuilders.get("http://localhost:5071/api/prezzi/cerca/codice/002000301")
	...
	@Test
	public void A_GetPrzCodArtTestListino2_OK() throws Exception {
		MockHttpServletRequestBuilder httpMockRequest = MockMvcRequestBuilders.get("http://localhost:5071/api/prezzi/002000301")
																			  .accept(MediaType.APPLICATION_JSON);
	...
	@Test
	public void B_GetPrzCodArtTestListino2_KO() throws Exception {
		MockHttpServletRequestBuilder httpMockRequest = MockMvcRequestBuilders.get("http://localhost:5071/api/prezzi/0020003012")
																			  .accept(MediaType.APPLICATION_JSON);
	...
	public void A_testInserimentoPrezzo() throws Exception {
		...
		MockHttpServletRequestBuilder httpMockRequest = MockMvcRequestBuilders.post("http://localhost:5071/api/prezzi/inserisci")
	...
	public void E_testCancellazionePrezzo() throws Exception {
		MockHttpServletRequestBuilder httpMockRequest = MockMvcRequestBuilders.delete("http://localhost:5071/api/prezzi/elimina/002000301/3")
																			  .accept(MediaType.APPLICATION_JSON);
